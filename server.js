...
app.get('/api/avatar/:id', (req, res) => {
  ...
  const { id, name, background, bg_video, model_file, idle_start, idle_end,
          ...
          idle_timeout, idle_icon, idle_icon_img, idle_video, idle_bg_image, idle_bg_color, idle_bg_color_alpha, idle_bg_opacity, idle_title, idle_subtitle, idle_hint, idle_font, idle_font_size,
...
app.put('/api/admin/avatars/:id', (req, res) => {
  const fields = ['name','voice_id','system_prompt','background','idle_start','idle_end',
                  ...
                  'idle_timeout','idle_icon','idle_title','idle_subtitle','idle_hint','idle_font','idle_font_size','idle_bg_image','idle_bg_color','idle_bg_color_alpha','idle_bg_opacity','theme',
                  'chat_font','chat_font_size',
                  'show_controls',
